    ...
    <div class="container">
        ...
        <div class="main">
            <div class="contactform">
                ...
                <form method="post" action="/contact/contact.html">
                    <div class="mb-3">
                        <label for="clientemail" class="form-label">Enter Your Name</label>
                        <input type="Text" class="form-control" id="clientemail" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                        <label for="clientemail" class="form-label">Email address</label>
                        <input type="email" class="form-control" id="clientemail" aria-describedby="emailHelp">
                        <div id="emailHelp" class="form-text">We'll never share your email address with anyone
                            else.</div>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="clientphone" class="form-label">Enter Your Enquiries</label>
                    ...
                    <div class="mb-3" id="form-check">
                        ...
                        <label class="form-check-label" for="isclient">I went you to work on a project with me</label>
                    </div>
